...
- version id: `e5bc5c97-a6fb-4ccb-b7df-be6dcfee9c43`
- version name: `初译·高级班内部讨论`
...
- 该版本包含 `13006` 条翻译单元，生成 `191` 个预算内 chunk。
- 抽取 `4039` 个术语候选、`200` 个开放式固定搭配候选、`18` 类开放式句式候选。
- 生成 `16861` 条证据记录，知识条目均保留可追溯 `unit_key`。
