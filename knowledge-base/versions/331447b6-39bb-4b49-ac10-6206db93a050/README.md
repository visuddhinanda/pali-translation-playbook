...
- version id: `331447b6-39bb-4b49-ac10-6206db93a050`
- version name: `钱玮`
...
- 该版本包含 `6350` 条翻译单元，生成 `117` 个预算内 chunk。
- 抽取 `1756` 个术语候选、`200` 个开放式固定搭配候选、`18` 类开放式句式候选。
- 生成 `6721` 条证据记录，知识条目均保留可追溯 `unit_key`。
