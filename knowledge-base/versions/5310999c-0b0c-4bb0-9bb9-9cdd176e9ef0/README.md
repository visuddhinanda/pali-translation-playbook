...
- version id: `5310999c-0b0c-4bb0-9bb9-9cdd176e9ef0`
- version name: `法句义注中译组——一校`
...
- 该版本包含 `8650` 条翻译单元，生成 `55` 个预算内 chunk。
- 抽取 `1077` 个术语候选、`200` 个开放式固定搭配候选、`18` 类开放式句式候选。
- 生成 `7869` 条证据记录，知识条目均保留可追溯 `unit_key`。
